...
<head>
    ...
    <title>LMS | Admin Dashboard - Update Category</title>
...
<div class="container headings text-center" style="margin-bottom:35px;">
		<h3 class="text-center font-weight-bold">Edit Category ID. : <?php echo $_GET['cid']; ?></h3>
</div>
    ...
    <div class="row">
        ...
        <form action="" method="post">
                ...
                <div class="form-group">
                 ...
                 <button class="btn btn-primary" name="update_cat">Update Category</button>
            </form>
        </div>
    </div>
</div>
