...
<head>
    ...
    <title>LMS | Admin Dashboard - Manage Category</title>
...
<div class="container headings text-center" style="margin-bottom:35px;">
		<h2 class="text-center font-weight-bold">Manage Categories</h2>
</div>
            ...
            <table class="table table-bordered table-hover"  style="text-align: center; overflow:auto;"> 
                <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn"><a href="edit_cat.php?cid=<?php echo $row['cat_id'];?>" style="text-decoration:none;">
                            Edit</a></button>
                            <button class="btn"><a href="delete_cat.php?cid=<?php echo $row['cat_id'];?>" style="text-decoration:none;">
                            Delete</a></button>
