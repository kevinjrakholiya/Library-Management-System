<?php
    ...
    $book_author = "";             
    $issue_date = "";  
    $query= "select book_no,book_name,book_author,issue_date 
    from issued_books where student_id=$_SESSION[id] and status=1";
...
<head>
    ...
    <title>LMS | User Issued Books </title>
...
<div class="container headings text-center" style="margin-bottom:35px;">
		<h2 class="text-center font-weight-bold">Issued Books</h2>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-10 col-12 offset-lg-2 offset-md-1">
            <form>
            <table class="table-bordered" width="100%" style="text-align: center; overflow:auto;"> 
                    <tr>
                        <th>Book No.</th>
                        <th>Name</th>
                        <th>Author</th>
